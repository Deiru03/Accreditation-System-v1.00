    ...
    <div class="flex min-h-full items-center justify-center p-4">
        <div class="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all sm:w-full sm:max-w-2xl"
            ...
            <div class="px-4 py-5 sm:p-6">
                <form method="POST" action="{{ route('iqa.users.store') }}">
                    @csrf
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        <button type="button" @click="$store.modal.closeUserCreate()" 
                                class="inline-flex justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
                            Cancel
                        </button>
                        <button type="submit" 
                                class="inline-flex justify-center rounded-md border border-transparent bg-blue-700 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-800">
                            Create User
                        </button>
                    </div>
                </form>
